...
pub trait Interpreter {
    ...
    fn load(&mut self, source: &Operand, destination: &Operand, space: Arc<AddressSpace>) -> Result<Outcome<Self::Outcome>, Self::Error>;
    fn store(&mut self, source: &Operand, destination: &Operand, space: Arc<AddressSpace>) -> Result<Outcome<Self::Outcome>, Self::Error>;
